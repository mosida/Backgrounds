...
import com.galeapp.backgrounds.adapter.RecentImgAdapter;
...
public class RecentActivity extends Activity {
	...
	private RecentImgAdapter imageAdapter;
	...
	private String getJsonData() {
		// String jsonStr =
		// HttpDownloader.downloadTextFromUrl(Constants.RECENT_URL,
		// HttpDownloader.DEFAULT_CHARSET_NAME);
		String jsonStr = HttpDownloader.getHttpJsonData(Constants.RECENT_URL);
		// 下载json数据
	...
	private void setupViews() {
		...
		imageAdapter = new RecentImgAdapter(getApplicationContext(), recents);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				i.setClass(RecentActivity.this, PreviewActivity.class);
				startActivity(i);
